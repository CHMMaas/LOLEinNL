...
local combined_figure_path = "G:\IKNL\Registratie en Onderzoek\Onderzoek\projecten lopend\LOLE\Hoog-over\Results\Review\Cancer deaths"
...
// file open CancerDeaths using "G:\IKNL\Registratie en Onderzoek\Onderzoek\projecten lopend\LOLE\Hoog-over\Results\Review\Cancer deaths\Cancer_Deaths.txt", write replace
// file write CancerDeaths "Disease" _tab "jaar" _tab "nr_of_deaths" _n
// foreach disease in `diseases'{	
// 	/* load data */ 
// 	quietly use "G:\IKNL\Registratie en Onderzoek\Onderzoek\projecten lopend\LOLE\Hoog-over\Data\kern1508.dta", clear
//	
...
// 	save "G:\IKNL\Registratie en Onderzoek\Onderzoek\projecten lopend\LOLE\Hoog-over\Results\Review\Cancer deaths\temp.dta", replace
//
// 	forval year_val = 1989/2019 {
// 		use "G:\IKNL\Registratie en Onderzoek\Onderzoek\projecten lopend\LOLE\Hoog-over\Results\Review\Cancer deaths\temp.dta", clear
// 		/* Keep only one year */
...
// insheet using "G:\IKNL\Registratie en Onderzoek\Onderzoek\projecten lopend\LOLE\Hoog-over\Results\Review\Cancer deaths\Cancer_Deaths.txt", clear
// save "G:\IKNL\Registratie en Onderzoek\Onderzoek\projecten lopend\LOLE\Hoog-over\Results\Review\Cancer deaths\Cancer_Deaths.dta", replace

// // Load information on number of inhabitants in the Netherlands per year
// insheet using "G:\IKNL\Registratie en Onderzoek\Onderzoek\projecten lopend\LOLE\Hoog-over\Results\Review\Cancer deaths\Bevolkingsteller_NL.csv", delimiter(;) clear
// destring bevolking, replace dpcomma
// replace bevolking = bevolking*1000000
// save "G:\IKNL\Registratie en Onderzoek\Onderzoek\projecten lopend\LOLE\Hoog-over\Results\Review\Cancer deaths\Bevolkingsteller_NL.dta", replace
...
foreach disease in `diseases'{
	...
	file open LOLEunadjusted using "G:\IKNL\Registratie en Onderzoek\Onderzoek\projecten lopend\LOLE\Hoog-over\Results\Review\Cancer deaths\LOLE_`disease'_unadjusted.txt", write replace
	...
	cd "G:\IKNL\Registratie en Onderzoek\Onderzoek\projecten lopend\LOLE\Hoog-over\Results\Review\Cancer deaths"
	...
	rename jaar _jaar
	save "G:\IKNL\Registratie en Onderzoek\Onderzoek\projecten lopend\LOLE\Hoog-over\Results\Review\Cancer deaths\Alpha.dta", replace
	...
	file open LOLEadjusted using "G:\IKNL\Registratie en Onderzoek\Onderzoek\projecten lopend\LOLE\Hoog-over\Results\Review\Cancer deaths\LOLE_`disease'_adjusted.txt", write replace
